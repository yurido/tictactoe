...
public class GameTest {
    ...
    private static int MAX_NUMBER_OF_GAMES_FOR_BATLLE_3X3 = 5380;
    private static int MAX_NUMBER_OF_GAMES_FOR_LEARNING_3X3 = 5380;
    private static long MAX_NUMBER_OF_NODES_3X3 = 362880;
    private static long MAX_REAL_NUMBER_OF_NODES_BATTLE_3X3 = 13527;
    private static long MAX_REAL_NUMBER_OF_NODES_LEARNING_3X3 = 13540;
    ...
    public void testBattleRegime() throws TicTacToeException, NodeNotFoundException, UpdateStatusException {
        ...
        assertEquals(MAX_NUMBER_OF_GAMES_FOR_BATLLE_3X3, numberOfGames);
    ...
    private boolean playNewGame(Game game, GameFigure figure) throws TicTacToeException, NodeNotFoundException, UpdateStatusException {
